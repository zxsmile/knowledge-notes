...
![webpack148](..\images\webpack148.png)
...
4. 1. 如果体积**「小于」** `minSize` 则取消这次分包，对应的 Module 依然会被合并入原来的 `Chunk` 
...
![webpack151](..\images\webpack151.png)
...
大致上我们可以将运行时理解为一种补齐模块化、异步加载等能力的应用骨架，用于支撑 `Webpack` 产物在各种环境下的正常运行。
